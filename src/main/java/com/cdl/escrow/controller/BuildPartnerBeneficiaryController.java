...
@RestController
@RequestMapping("/api/v1/asset-register-beneficiary")
@RequiredArgsConstructor
@Slf4j
@Tag(name = "asset-register-beneficiary-controller", description = "APIs for managing asset register beneficiary")
