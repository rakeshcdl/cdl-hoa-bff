...
@Getter
@Setter
public class OwnerRegistryUnitCriteria implements Serializable {
   ...
   // private Set<OwnerRegistryUnitDTO> childCapitalPartnerUnitDTO ;

   // private Set<BankAccountDTO> bankAccountDTOS ;

    //private Set<OwnerRegistryDTO> capitalPartnerDTOS ;
